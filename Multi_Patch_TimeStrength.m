...
% Matlab code to generate all csv files under both strength and early intervention in the manuscript titled "How public reaction to disease information across scales and the impacts of vector control methods influence disease prevalence and control efficacy"

% =========================================================================================================================================================================================================================================
 
function [S_out, I_out, R_out]  = Multi_Patch_TimeStrength(folder, information, MaxTime, p, alpha, gamma, epsilon, N, seed, network)
...
if nargin == 0                          % if the number of input arguments is zero
    ...
    folder = join([network, information, 'N', string(N),'p', string(p), 't', string(MaxTime),'K=2000','time+strength+control'], {'-'} );
    mkdir(folder)
end
...
for i = 1:N
    ...
    X0  = [X0; ini];
    Kl  = [Kl; 2000 + randi(10,1,1)];  %carrying capacity of each patch: 500, 800 and 2000
end
